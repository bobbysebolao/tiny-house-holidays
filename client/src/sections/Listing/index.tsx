...
export const Listing = ({ viewer, match }: Props & RouteComponentProps<MatchParams>) => {
    ...
    const listingCreateBookingElement = listing ? <ListingCreateBooking viewer={viewer} host={listing.host} price={listing.price} bookingsIndex={listing.bookingsIndex} checkInDate={checkInDate} checkOutDate={checkOutDate} setCheckInDate={setCheckInDate} setCheckOutDate={setCheckOutDate}/> : null;
